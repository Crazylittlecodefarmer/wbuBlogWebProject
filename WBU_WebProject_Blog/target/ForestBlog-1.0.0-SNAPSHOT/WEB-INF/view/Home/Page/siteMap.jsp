...
<rapid:override name="left">
    ...
    <section id="primary" class="content-area" style="background: #fff;">
        <main id="main" class="site-main" role="main">
            <div class="mtc-collapse">
                <div class="mtc-colla-item">
                    <h2 class="mtc-colla-title">文章列表</h2>
                    <div class="mtc-colla-content mtc-show">
                        <ul>
                ...
                <div class="mtc-colla-item">
                    <h2 class="mtc-colla-title">分类目录</h2>
                    <div class="mtc-colla-content mtc-show">
                        <ul>
                ...
                <div class="mtc-colla-item">
                    <h2 class="mtc-colla-title">标签库</h2>
                    <div class="mtc-colla-content mtc-show">
...
<rapid:override name="footer-script">
    <script>
        ...
        mtc.use('element', function(){
            var element = mtc.element;
