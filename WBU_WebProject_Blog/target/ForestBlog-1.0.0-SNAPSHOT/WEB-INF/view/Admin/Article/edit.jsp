...
<rapid:override name="content">
    ...
    <form class="mtc-form" method="post" id="myForm" action="/admin/article/editSubmit">
        ...
        <div class="mtc-form-item mtc-form-text">
            ...
            <div class="mtc-input-block">
                <textarea class="mtc-textarea mtc-hide" name="articleContent"
            ...
            <div class="mtc-input-inline">
                <div class="mtc-upload">
                    <div class="mtc-upload-list" style="">
                        <img class="mtc-upload-img"  id="demo1" width="100" src="${article.articleThumbnail}"
                             height="100">
                        <p id="demoText"></p>
                    </div>
