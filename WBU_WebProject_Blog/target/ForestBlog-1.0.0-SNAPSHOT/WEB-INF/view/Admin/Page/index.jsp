...
<rapid:override name="content">
    ...
    <fieldset class="mtc-elem-field mtc-field-title" style="margin-top: 20px;">
        <legend>页面列表</legend>
    </fieldset>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/admin/page/edit/${p.pageId}"
                               class="mtc-btn mtc-btn-mini">编辑</a>
                            <a href="/admin/page/delete/${p.pageId}"
                               class="mtc-btn mtc-btn-danger mtc-btn-mini" onclick="return confirmDelete()">删除</a>
                        </td>
                    </tr>
                </c:if>
            </c:forEach>
    ...
    <div class="mtc-form">
        <table class="mtc-table" style="width: 40%;">
            <colgroup>
                <col width="150">
                <col width="150">
                <col width="200">
