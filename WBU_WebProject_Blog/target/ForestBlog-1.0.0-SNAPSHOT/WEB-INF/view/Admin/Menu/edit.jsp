...
<rapid:override name="content">
    ...
    <div class="mtc-row">
        <div class="mtc-col-md4" >
            <form class="mtc-form"  method="post" id="myForm" action="/admin/menu/editSubmit">
                <div class="mtc-form-item">
                    ...
                    <div class="mtc-input-block">
                        ...
                        <input type="text" name="menuName" value="${menu.menuName}" autocomplete="off" class="mtc-input" required>
                    </div>
                    <br>
                    <div class="mtc-input-block">
                        URL
                        <span style="color: #FF5722; ">*</span>
                        <input type="text" name="menuUrl" value="${menu.menuUrl}" autocomplete="off" class="mtc-input" required>
                    </div>
                    <br>
                    <div class="mtc-input-block">
                        图标
                        <input type="text" name="menuIcon" value="${menu.menuIcon}" mtc-input="" class="mtc-input"  >
                    </div>
                    <br>
                    <div class="mtc-input-block">
                        菜单位置
                    ...
                    <div class="mtc-input-block">
                        Order
                        <input type="number" name="menuOrder" value="${menu.menuOrder}" mtc-input="" class="mtc-input" min="0" max="10" required>
                    </div>
                    <br>
                    <br>
                    <div class="mtc-input-block">
