...
<rapid:override name="content">
    ...
    <div class="mtc-row">
        <div class="mtc-col-md4">
            <form class="mtc-form" method="post" id="myForm" action="/admin/link/insertSubmit">
                <div class="mtc-form-item">
                    ...
                    <div class="mtc-input-block">
                        ...
                        <input type="text" name="linkName" value="" autocomplete="off" class="mtc-input" required>
                    </div>
                    <br>
                    <div class="mtc-input-block">
                        URL <span style="color: #FF5722; ">*</span>
                        <input type="text" name="linkUrl" value="" autocomplete="off" class="mtc-input" required>
                    </div>
                    <br>
                    <div class="mtc-input-block">
                        联系方式
                        <input type="text" name="linkOwnerContact" value="" autocomplete="off" class="mtc-input" >
                    </div>
                    <br>
                    <div class="mtc-input-block">
                        描述
                        <input type="text" name="linkDescription" value="" autocomplete="off" class="mtc-input" >
                    </div>

                    <br>
                    <div class="mtc-input-block">
                         Order
                        <input type="number" name="linkOrder" value="" autocomplete="off" class="mtc-input" min="0" max="10">
                    </div>
                    <br>
                    <div class="mtc-input-block">
