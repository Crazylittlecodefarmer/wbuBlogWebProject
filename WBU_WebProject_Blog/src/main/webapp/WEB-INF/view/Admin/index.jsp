                    ...
                    <form name="post" method="post" id="insertDraftForm"
                        ...
                        <div class="mtc-form-item">
                            <div class="mtc-input-block">
                                <input type="text" name="articleTitle" id="articleTitle" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="mtc-input">
                            </div>
                        </div>
                        <div class="mtc-form-item mtc-form-text">
                            <div class="mtc-input-block">
                                <textarea name="articleContent" placeholder="请输入内容" id="articleContent" class="mtc-textarea" required></textarea>
                            </div>
                        </div>
                        <input type="hidden" name="articleStatus" value="0">
                        <div class="mtc-form-item">
                            <div class="mtc-input-block">
                                <button class="mtc-btn mtc-btn-small" lay-submit lay-filter="formDemo" onclick="insertDraft()">保存草稿</button>
                                <button type="reset" class="mtc-btn mtc-btn-small mtc-btn-primary">重置</button>
                            </div>
                        </div>
